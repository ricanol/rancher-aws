...
#variable "node_public_ip_dev" {
#  type        = string
#  description = "Public IP of compute node for Rancher cluster"
#}

#variable "node_internal_ip_dev" {
#  type        = string
#  description = "Internal IP of compute node for Rancher cluster"
#  default     = ""
#}
...
variable "workload_cluster_name" {
  type        = string
  description = "Name for created custom workload cluster Prod"
}

# Required
variable "workload_cluster_name_dev" {
  type        = string
  description = "Name for created custom workload cluster Dev"
}
